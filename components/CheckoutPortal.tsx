...
import { X, MapPin, Truck, Gift, CreditCard, CheckCircle2, ShieldCheck, ArrowRight, Navigation, Clock, PackageCheck } from "lucide-react";
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div className="flex justify-between items-center pt-4">
                  ...
                  >
                    {isProcessing ? (
                      ...
                      <>
                        <span>AUTHORIZE ORDER · ${(subtotal + 12).toFixed(2)}</span>
                        <ArrowRight className="w-4 h-4" />
                      </>
                    )}
                  </button>
              ...
              <div className="md:col-span-5 bg-dark-choc/80 rounded-2xl p-4 border border-champagne/15 space-y-4">
                ...
                <div className="border-t border-champagne/10 pt-2 text-xs space-y-1">
                  ...
                  <div className="flex justify-between text-cream/60"><span>Express Chilled Shipping</span><span>$12.00</span></div>
                  <div className="flex justify-between font-serif text-lg text-champagne pt-2"><span>Total</span><span>${(subtotal + 12).toFixed(2)}</span></div>
                </div>
              </div>
            </div>
          )}
